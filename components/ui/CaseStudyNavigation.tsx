        ...
        {otherCaseStudies.map((cs, idx) => (
          <motion.article
            ...
            className={cn(
              ...
              "bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl shadow-sm hover:shadow-lg hover:border-primary/30 transition-all duration-300 cursor-pointer"
            )}
            onClick={() => (window.location.href = `/case-studies/${cs.id}`)}
          >
            {/* Top accent bar */}
            <div
              className={cn(
