...
export function usePlatformStyles() {
  ...
  return useMemo(() => {
    ...
    const gradients = branding?.gradients || defaultGradients;
    const shadows = branding?.shadows || defaultShadows;
    ...
    return {
      ...
      styles: {
        ...
        primaryGradient: { background: gradients.primary },
        secondaryGradient: { background: gradients.secondary },
        accentGradient: { background: gradients.accent },
        backgroundGradient: { background: gradients.background },
        primaryShadow: { boxShadow: shadows.md },
        largeShadow: { boxShadow: shadows.lg },
      },
