...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/-aman-ansari",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/aman_ansari__________/",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "Email",
      href: "mailto:iamamanansari786a@gmail.com",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
  ...
  return (
    <footer
      id="contact"
      className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white relative overflow-hidden"
    >
      {/* Modern background elements */}
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          className="absolute top-40 left-20 w-96 h-96 bg-gradient-to-br from-blue-400/10 to-purple-400/10 rounded-full blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.3, 0.6, 0.3],
          }}
        ...
        />
        <motion.div
          className="absolute bottom-40 right-20 w-80 h-80 bg-gradient-to-tr from-purple-400/10 to-pink-400/10 rounded-full blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.4, 0.2, 0.4],
          }}
            ...
            >
              {socialLinks.map((link, index) => (
                <motion.a
                  ...
                  className="group relative p-3 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-blue-400/50 transition-all duration-300"
