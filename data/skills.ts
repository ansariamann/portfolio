...
export const skills: Skill[] = [
  ...
  // Backend Technologies
  {
    ...
    proficiency: 5,
    icon: "java",
    description: "Enterprise application development with Spring Boot and robust OOP principles",
    yearsOfExperience: 2,
    color: "#b07219",
    relatedSkills: ["spring", "aws", "postgresql"],
  },
  {
    id: "spring",
    name: "Spring Boot",
    ...
    proficiency: 4,
    icon: "spring",
    description: "Building scalable backend microservices and REST APIs",
    yearsOfExperience: 1.5,
    color: "#6db33f",
    relatedSkills: ["java", "aws"],
  },
  {
    id: "ml",
    ...
    proficiency: 4,
    icon: "python",
    description: "Building and training intelligent predictive models and AI algorithms",
    yearsOfExperience: 1,
    color: "#FFD43B",
    relatedSkills: ["python", "aws", "java"],
  },
  {
    id: "nodejs",
    name: "Node.js",
