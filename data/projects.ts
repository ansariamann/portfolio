...
export const projects: Project[] = [
  ...
  },
  {
    id: "gh-1247286941",
    title: "pattern-whiz",
    description: "pattern-whiz repository",
    longDescription: "Fetched from GitHub repository: pattern-whiz",
    technologies: ["JavaScript"],
    category: "web",
    images: ["/images/placeholder.svg"],
    githubUrl: "https://github.com/ansariamann/pattern-whiz",
    featured: false,
  ...
  },
  {
    id: "gh-1316965204",
    title: "store-rating",
    description: "store-rating repository",
    longDescription: "Fetched from GitHub repository: store-rating",
    technologies: ["JavaScript"],
    category: "web",
    images: ["/images/placeholder.svg"],
    githubUrl: "https://github.com/ansariamann/store-rating",
    featured: false,
    completedDate: new Date(),
    status: "completed",
    highlights: [],
  ...
  {
    id: "gh-1310702350",
    title: "confessionroulette",
    description: "confessionroulette repository",
    longDescription: "Fetched from GitHub repository: confessionroulette",
    technologies: ["JavaScript"],
    category: "web",
    images: ["/images/placeholder.svg"],
    githubUrl: "https://github.com/ansariamann/confessionroulette",
    featured: false,
    completedDate: new Date(),
    status: "completed",
    highlights: [],
  ...
  },
  {
    ...
    description: "telegram-cloud-drive repository",
    longDescription: "Fetched from GitHub repository: telegram-cloud-drive",
    technologies: ["TypeScript"],
    category: "web",
    images: ["/images/placeholder.svg"],
    githubUrl: "https://github.com/ansariamann/telegram-cloud-drive",
    featured: false,
    completedDate: new Date(),
    status: "completed",
    highlights: [],
